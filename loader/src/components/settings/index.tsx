  ...
  return (
    ...
    >
      ...
      <div class="border-[1px] border-foreground/15 bg-card rounded-[12px] relative flex w-[800px] h-[460px]">
        <span
          class="absolute top-2 right-2 flex justify-center items-center w-8 h-8 text-slate-300 hover:text-white hover:bg-neutral-500/20 rounded-lg"
        ...
        <div class="flex flex-col bg-black/10 p-4 w-[210px] py-8">
          <h1 class="text-neutral-400 text-lg font-bold mx-4">
            {i18n.t("settings")}
          </h1>
